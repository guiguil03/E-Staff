...
// Colonne "Administrer & Communiquer" — pointage rapide, diffusion de
// message, Vivier C1 et recherche d'apprenant. Pointage et diffusion
// restent en état local (pas de backend de présence/messagerie pour
// l'instant) ; honnête sur ce qui est simulé vs. vraiment envoyé.
export default function AdminColumn({ onSelectApprenant, onOpenReport }: AdminColumnProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Reveal delay={120}>
        <div className="rounded border border-accent/30 bg-obsidianCard p-6 text-center">
          <h3 className="font-display text-base font-semibold text-white">
