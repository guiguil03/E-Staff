      ...
      <div className="mx-auto max-w-4xl text-center">
        <Reveal>
          <Image
            ...
            width={112}
            height={112}
            className="mx-auto h-16 w-16 rounded-full object-cover shadow-lg shadow-black/40 ring-1 ring-accent/30 sm:h-20 sm:w-20 md:h-24 md:w-24"
            priority
          />
        </Reveal>
        ...
        <Reveal delay={160}>
          <h1 className="mt-6 font-display text-3xl font-semibold leading-tight text-white sm:text-4xl md:text-5xl">
        ...
        <Reveal delay={240}>
          <p className="mx-auto mt-6 max-w-2xl font-sans text-base text-white/70 sm:text-lg">
