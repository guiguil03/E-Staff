...
// Planification du "Live du mois" du Forum — extrait de l'ancien
// AdminDashboard.tsx (page unique) pour vivre sous Paramètres RH dans le
// nouveau Portail RH multi-pages, sans changer la logique.
export default function ForumLivePanel() {
